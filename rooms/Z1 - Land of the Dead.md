...
Lying in one corner of the room is a beautifully carved crystal skull. It appears to be grinning rather nastily.

## Exits (as reported)
- N → [[Z1 - Entrance to Hades]]
...
## Mapping notes
**Internal ID**: Z1-R-037
**First mapped**: 2026 Feb. 5
**Revisions**:
